...
public static class Serializer
{
    ...
    public static bool generateExcelFileClient(List<Clients> clients)
    {
        try
        {
            ...
            // name of the sheet
            var workSheet = excel.Workbook.Worksheets.Add("Client Details");
            ...
            workSheet.Cells[1, 5].Value = "Phone Number";
            workSheet.Cells[1, 6].Value = "Business#";
            workSheet.Cells[1, 7].Value = "HSTPeriod";
            workSheet.Cells[1, 8].Value = "Additional Notes";
            workSheet.Cells[1, 9].Value = "Address";
            workSheet.Cells[1, 10].Value = "Category Name";
            workSheet.Cells[1, 11].Value = "Company Key";
            workSheet.Cells[1, 12].Value = "Corporation Key";
            workSheet.Cells[1, 13].Value = "Corporation Type";
            workSheet.Cells[1, 14].Value = "CRA Password";
            workSheet.Cells[1, 15].Value = "CRA User Id";
            workSheet.Cells[1, 16].Value = "Incorporation Date";
            workSheet.Cells[1, 17].Value = "Incorporation Month";
            workSheet.Cells[1, 18].Value = "Notes";
            workSheet.Cells[1, 19].Value = "Ontario One Key Password";
            workSheet.Cells[1, 20].Value = "Ontario One Key User";
            workSheet.Cells[1, 21].Value = "Status";
            workSheet.Cells[1, 22].Value = "Year End";
            ...
            {
                workSheet.Cells[recordIndex, 1].Value = client.SerialNumber;
                workSheet.Cells[recordIndex, 2].Value = client.ClientName;
                workSheet.Cells[recordIndex, 3].Value = client.CompanyName;
                workSheet.Cells[recordIndex, 4].Value = client.Email;
                workSheet.Cells[recordIndex, 5].Value = client.PhoneNumber;
                workSheet.Cells[recordIndex, 6].Value = client.Business;


                workSheet.Cells[recordIndex, 7].Value = client.HSTPeriod;
                workSheet.Cells[recordIndex, 8].Value = client.AdditionalNotes;
                workSheet.Cells[recordIndex, 9].Value = client.Address;
                workSheet.Cells[recordIndex, 10].Value = client.CategoryName;
                workSheet.Cells[recordIndex, 11].Value = client.CompanyKey;
                workSheet.Cells[recordIndex, 12].Value = client.CorporationKey;
                workSheet.Cells[recordIndex, 13].Value = client.CorporationType;
                workSheet.Cells[recordIndex, 14].Value = client.CRAPassword;
                workSheet.Cells[recordIndex, 15].Value = client.CRAUserId;
                workSheet.Cells[recordIndex, 16].Value = client.IncorporationDate;
                workSheet.Cells[recordIndex, 17].Value = client.IncorporationMonth;
                workSheet.Cells[recordIndex, 18].Value = client.Notes;
                workSheet.Cells[recordIndex, 19].Value = client.OntarioOneKeyPassword;
                workSheet.Cells[recordIndex, 20].Value = client.OntarioOneKeyUser;
                workSheet.Cells[recordIndex, 21].Value = client.Status;
                workSheet.Cells[recordIndex, 22].Value = client.YearEnd;
...
#if DEBUG
            string p_strPath = @"C:\POC\DeepXML\" + "Client Details.xlsx";
#else
            string p_strPath = @"D:\Data\Mankoo & Gupta\ExportedExcelM&G\" + "Client Details.xlsx";
#endif
